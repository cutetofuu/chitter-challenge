...
def test_all_with_usernames(db_connection):
    db_connection.seed('seeds/peeps_table.sql')
    repo = PeepRepository(db_connection)

    result = repo.all_with_usernames()
    assert result == [
        Peep(3, 'I am a cute little kitty cat, and I had a really long nap just now! #toughlife','2023-05-16 14:15:54', 3, 'Pickle', 'pickle_test'),
        Peep(1, 'Hello! This is my very first chitter message!', '2023-05-10 09:05:06', 4, 'John', 'john_test'),
        Peep(2, 'Today I made a shop manager program using Python, Pytest, Psycopg and PostgreSQL #100daysofcode', '2023-04-22 17:38:19', 1, 'David', 'dave_test'),
        Peep(4, 'Had a great time at the Makers Academy today! It was fun learning about databases and web apps in Python', '2023-03-08 16:45:30', 2, 'Jane', 'jane_test')
    ]